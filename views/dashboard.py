...
def render_dashboard(user_name, user_role):
    ...
    # 1. Top Metrics Display (Mobile Friendly 2-Column Grid Layout)
    ...
    # 2. Tasks & Action Items (Prioritized First for Quick Mobile Viewing)
    ...
    # 5. Category Overview (Wrapped in Expanders for Mobile Cleanliness)
